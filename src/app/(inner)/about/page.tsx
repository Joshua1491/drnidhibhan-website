      ...
      <section className="section-padding bg-blush-light">
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-up">
            <div
              className="w-full aspect-[3/4] rounded-3xl bg-blush flex items-center justify-center"
              style={{ border: "1px solid rgba(197,166,107,0.15)" }}
            >
              <span className="text-text-muted text-sm tracking-widest uppercase font-body">
                Photo Coming Soon
              </span>
            </div>
          </div>
