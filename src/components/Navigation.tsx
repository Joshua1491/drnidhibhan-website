  ...
  return (
    ...
    >
      ...
      <Link href="/" className="no-underline block">
        <span
          className="block text-[1.45rem] font-semibold leading-tight"
          style={{ fontFamily: "var(--font-heading), 'Cormorant Garamond', serif", color: "var(--charcoal)" }}
        >
          Dr. Nidhi Bhan
        </span>
        <span
          className="block text-[0.68rem] font-light tracking-[0.3em] uppercase mt-[1px]"
          style={{ fontFamily: "var(--font-body), 'Outfit', sans-serif", color: "var(--text-muted)" }}
        >
